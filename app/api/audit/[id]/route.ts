  ...
  if (process.env.NODE_ENV === "development") {
    response.debugData = {
      ...
      classification: {
        ...
        reasoning: data.classification_reasoning?.evidence ? undefined : data.classification_reasoning,
        evidence: data.classification_reasoning?.evidence,
        deterministicScore: data.classification_reasoning?.deterministicScore,
        aiAgreement: data.classification_reasoning?.aiAgreement,
        voteBreakdown: data.classification_reasoning?.voteBreakdown,
      },
