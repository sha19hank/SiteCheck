...
export default function ReportLayout({ sections, header, children, isPaid = false, isDeveloper = false }: ReportLayoutProps) {
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 py-12 sm:py-20 flex flex-col gap-12 lg:gap-16 scroll-smooth">
      ...
      <div className="flex flex-col md:flex-row items-start gap-12 relative">
        <StickyNav sections={sections} isPaid={isPaid} isDeveloper={isDeveloper} />
